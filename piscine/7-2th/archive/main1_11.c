...
/*   Updated: 2022/06/02 13:44:40 by donghki2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int main(int argc, char *testInput[50])
{
	...
	printf("After strncpy (size 5) : ");
	printStr(testStr3);
	printf("\n");

	strncpy(testStr3, testStr1, 0);
	printf("real strncpy(size 5) : ");
	printStr(testStr3);
	printf("\n");
	...
	result = 0;
	result = ft_strlcpy (testStr2, testStr1, 15);
	printf ("ft_Strlcpy : ");
	printStr (testStr2);
	printf ("\n");
	printf ("Return %d\n\n", result);
	...
	result = 0;
	result = strlcpy (testStr3, testStr1, 15);
	printf ("real strlcpy : ");
	printStr (testStr3);
	printf ("\n");
	printf ("Return %d\n", result);
