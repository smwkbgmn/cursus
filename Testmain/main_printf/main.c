...
// 	printf("123456789A123456789A\n");
	...
	// printf("\n");
	// printf("[%d] ", printf("%.2147483648d", 0));
	// printf("\n");
	// printf("[%d] ", printf("%.2147483649d", 0));
	// printf("\n");
	// printf("[%d] ", printf("%.2147483650d", 0));
	// printf("\n");

	// ft_printf("[%d]", ft_printf("%.5d", 123));
	// ft_printf("[%d]\n", 5);

	ft_printf("%-+1.d, %-+1.d, %-+1.d, %-+1.d, %-+1.d, %-+1.d, %-+1.d, %-+1.d", 0, 5, -1, -10, 100, -1862, INT_MIN, INT_MAX);
