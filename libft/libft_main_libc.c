...
int main(void)
{
	...
	printf("total size of allocated_origin array\t[%zu]\n", malloc_size(allocated_int_origin));
	printf("each elem of allocated_origin array\n");
	idx = 0;
	...
	printf("total size of allocated_ft array\t[%zu]\n", malloc_size(allocated_int_ft));
	printf("each elem of allocated_ft array\n");
	idx = 0;
