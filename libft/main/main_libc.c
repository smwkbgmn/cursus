...
{ \
	...
	{ \
		if (type == 0) \
			printf("[%d]", zero_int_##which[idx++]); \
		else \
			printf("[%c]", zero_char_##which[idx++]); \
	} \
	printf("\n"); \
}
...
int main(void)
{
	...
	// int zero_int_origin[20] = {0, 1, 2, 3, 4};
	// int zero_int_ft[20] = {0, 1, 2, 3, 4};
	// char zero_char_origin[20] = "01234";
	// char zero_char_ft[20] = "01234";
