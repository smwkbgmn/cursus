...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_convert_base2_ul.c                              :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: donghyu2 <donghyu2@student.42seoul.kr>     +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/05 18:24:05 by donghyu2          #+#    #+#             */
/*   Updated: 2022/12/29 02:13:07 by donghyu2         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <stdlib.h>

static int		is_number(char letter, char *base);
static int		get_size(long long nbr_from, int rdx_to);
